...
var winHelper = require('./Startup/WinHelper.js')
...
StartupModule.startup = function startup(platform, opts, callback) {
  ...
  if (process.getuid() !== 0) {
    return StartupModule._warnUnprivileged(platform, opts.user, opts.hp, wrapIfError);
  }

  StartupModule._normalize(platform, opts.user, opts.hp, proceed);
